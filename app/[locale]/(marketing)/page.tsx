    ...
    <>
      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex flex-col items-start gap-4">
          <h1 
            className="font-heading text-2xl text-primary sm:text-4xl md:text-5xl  lg:text-5xl"
          ...
          <div className="xs:animate-none my-6 delay-700 duration-1000 animate-in fade-in slide-in-from-top-4 fill-mode-backwards">
            <div className="hidden md:block">
              ...
              <div className="mt-2 flex justify-center gap-4">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6 md:h-8 md:w-8" aria-label="Firefox">
      ...
      <section id="features" className="container space-y-6 bg-transparent">
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              <EyeOff className="size-12 text-primary" />
              <div className="space-y-2">
